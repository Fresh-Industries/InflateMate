      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
            {/* Social proof */}
            <div className="flex items-center justify-center lg:justify-start gap-2 text-sm text-muted mb-2">
            <Badge className="uppercase text-sm tracking-wide border-primary text-primary">
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl text-foreground leading-relaxed max-w-lg mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-6">
              <Button variant="primary-gradient" size="lg" className="group">
              ...
              <Button
                variant="outline"
                size="lg"
                className="group !border-muted !text-foreground bg-transparent backdrop-blur-sm"
              >
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="relative mx-auto max-w-[580px] rounded-3xl overflow-hidden shadow-2xl border border-white/10 bg-card/95 backdrop-blur-sm p-4 md:p-6 transform hover:-translate-y-2 transition-all duration-500">
              ...
              {/* Floating cards */}
              <div className="absolute top-4 right-4 bg-card/95 backdrop-blur-sm rounded-xl shadow-lg p-3 border border-muted transform hover:scale-105 transition-all duration-300">
              ...
              <div className="absolute bottom-4 left-4 bg-card/95 backdrop-blur-sm rounded-xl shadow-lg p-3 border border-muted transform hover:scale-105 transition-all duration-300">
                <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block absolute -bottom-2 right-1/4 bg-card rounded-xl shadow-lg p-3 border border-muted">
