  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "primary-gradient":
          "bg-gradient-to-r from-primary to-accent text-white rounded-full shadow-lg hover:scale-105 transform transition-transform duration-300 rounded-full",
        destructive:
          "bg-red-600 text-white shadow-sm hover:bg-red-600/90",
        outline:
          "border-2 border-primary text-primary rounded-full bg-transparent hover:bg-primary/10 shadow-sm rounded-full",
        secondary:
